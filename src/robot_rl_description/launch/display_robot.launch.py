...
def generate_launch_description():
    ...
    # 1. 获取 URDF 文件路径
    #    - 使用 package share 目录，避免依赖工作空间 src 下的硬编码路径
    urdf_package_path = get_package_share_directory('robot_rl_description')
    ...
    return launch.LaunchDescription([
        launch.actions.LogInfo(msg=['Loading fishbot model from: ', default_urdf_path]),
